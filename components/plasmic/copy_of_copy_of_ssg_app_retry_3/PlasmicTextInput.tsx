...
import sty from "./PlasmicTextInput.module.css"; // plasmic-import: gxI9w17xJzJp/css

import SearchsvgIcon from "./icons/PlasmicIcon__Searchsvg"; // plasmic-import: c8O3y7UOkRHF/icon
import ChecksvgIcon from "./icons/PlasmicIcon__Checksvg"; // plasmic-import: 1bUl6g_ovfLI/icon
    ...
    >
      ...
      >
        {renderPlasmicSlot({
          defaultContents: (
            <SearchsvgIcon
              className={classNames(projectcss.all, sty.svg__ixJp)}
              role={"img"}
            />
          ),
      ...
      >
        {renderPlasmicSlot({
          defaultContents: (
            <ChecksvgIcon
              className={classNames(projectcss.all, sty.svg__rcCRj)}
              role={"img"}
            />
          ),

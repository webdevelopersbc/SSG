...
import sty from "./PlasmicEditable.module.css"; // plasmic-import: Fvgpkf4ai71D/css
    ...
    >
      <div
        className={classNames(
          ...
          "editableText",
          {
            [sty.freeBoxeditEnabled___6XE7Dxn2I]: hasVariant(
              $state,
              "editEnabled",
              "editEnabled"
            )
      ...
      <div
        className={classNames(
          ...
          "textEditor",
          {
            [sty.freeBoxeditEnabled__hXenpdxn2I]: hasVariant(
              $state,
              "editEnabled",
              "editEnabled"
            )
      ...
      >
        {(hasVariant($state, "editEnabled", "editEnabled") ? true : false)
          ? renderPlasmicSlot({
              defaultContents: (
                <TextInput
                  className={classNames("__wab_instance", sty.textInput__uIybL)}
                  endIcon={null}
                  startIcon={null}
                />
              ),
